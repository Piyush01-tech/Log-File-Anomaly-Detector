...
USAGE (as a module):
  from train import AnomalyModelTrainer
...
class FeatureScaler:
    ...
    WHY A WRAPPER:
      ...
      - Phase 6 (predict.py) can import and use FeatureScaler.load()
        independently without importing the trainer.
    ...
    def save(self, path: Path) -> None:
        ...
        list so that Phase 6 can reconstruct the exact same scaler.
    ...
    def load(cls, path: Path) -> "FeatureScaler":
        ...
        This is the primary entry point for Phase 6 (predict.py).
